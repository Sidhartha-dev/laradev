...
<div class="row">
    <div class="col-md-12 maxcard">
        ...
        <div class="flipkart-comp card">
            ...
            <h4 class="text-primary px-2 text-center">{{$product->flipk_product_name}}</h4>
            <hr>
            <h2 class="text-primary px-2 py-3 text-center">Flipkart Details</h2>
            <p class="text-primary px-2 ">{{$product->flipkart_details}}</p>
            <hr>
            <h2 class="text-primary px-2 py-3 text-center">Flipkart Description</h2>
            <p class="text-primary px-2 ">{{$product->flipkart_description}}</p>
            <hr>
