...
<div class="row">
    <div class="col-md-12 maxcard">
        <div class="amazon-com card">
            ...
            <h4 class="text-success px-2 text-center">{{$product->amazon_ratings}}</h4>
            <hr>
        ...
        <div class="flipkart-comp card">
            ...
            <hr>
            <h2 class="text-success px-2 py-3 text-center">Flipkart prize</h2>
            <h4 class="text-success px-2 text-center">{{$product->flipkart_prize}} INR</h4>
            <hr>
            <h2 class="text-success px-2 py-3 text-center">Flipkart ratings</h2>
            <h4 class="text-success px-2 text-center">{{$product->flipkart_ratings}}</h4>
            <hr>
            <h2 class="text-success px-2 py-3 text-center">Flipkart assured</h2>
            <h4 class="text-success px-2 text-center">{{$product->flipkart_assured ? 'yes' : 'no'}}</h4>
            <hr>
            <a href="{{ $product->amazon_link }}" target="blank" class="btn btn-warning">Checkout Now</a>
        </div>
    </div>
